...
if (page == '/terms.html') {
    ...
    $('.banner-1 h2').html('Trade with VertexTrade and achieve financial success in the global markets!');
    $('.banner-1 h2 + p').html('Join us and start trading today!');
...
if (page == '/overview.html') {
    ...
    $('.banner-1 h2 + p').html('Trading with VertexTrade means choosing a reliable partner for financial success in the global markets.');
    $('.banner-1 .btn span').html('open an account');
}
...
if (page == '/contacts.html') {
    ...
    $('.hero__title').html('Get in Touch with VertexTrade');
    $('.hero__info').css('display', 'none');
    $('.hero__btn').css('display', 'none');
